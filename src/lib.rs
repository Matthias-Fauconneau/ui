...
pub mod prelude { pub use {fehler::throws, super::{Error, Result}}; }
...
#[cfg(feature="text")] pub mod text; #[cfg(feature="text")] pub use text::{background, Text}; //cfg_if! { if #[cfg(feature="text")] { pub mod text; pub use text::{Text, default_font, default_style}; }}
